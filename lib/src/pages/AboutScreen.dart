          ...
          */
          Padding(
            ...
            child: Center(
              ...
              renderDescription(),
              //textAlign: TextAlign.center,
              style: TextStyle(fontSize: 18, color:themeProvider.isLightTheme
                  ? Colors.black
            ...
            (Social social) => SocialItem(
                ...
                onTap: () async {
                  if (await canLaunchUrl(
                      social.linkUrl!.replaceAll("id_app", social.idApp!) as Uri)) {
                    await launchUrl(
                        social.linkUrl!.replaceAll("id_app", social.idApp!) as Uri);
                  } else {
                    launchUrl(social.url!.replaceAll("id_app", social.idApp!) as Uri);
                  }
                }),
          )
          .toList(),
