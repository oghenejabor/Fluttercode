...
class _AppBarItem extends State<AppBarItem> {
  ...
  Widget build(BuildContext context) {
    ...
    return AppBar(
        leading: IconButton(
          icon: Icon(Icons.arrow_back_ios, color:   themeProvider.isLightTheme
              ? HexColor(Setting.getValue(
              widget.settings.setting!, "iconColor"))
              : HexColor(Setting.getValue(
              widget.settings.setting!, "iconColor_dark"))),
        ...
        title: Text(
          ...
          style: TextStyle(
              color:  themeProvider.isLightTheme
                  ...
                  widget.settings.setting!, "iconColor"))
                  : HexColor(Setting.getValue(
                  widget.settings.setting!, "iconColor_dark")), fontSize: 22.0, fontWeight: FontWeight.bold),
        ),
